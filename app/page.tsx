...
export default function Page() {
  ...
  return (
    <main className="site-shell">
      ...
      <footer className="footer"><div className="footer-brand"><a href="#top" className="brand"><span className="brand-mark">F</span><span>FIELDCRAFT<span className="brand-sub">AGRICULTURAL SOLUTIONS</span></span></a><p>Practical solutions for<br />people who grow things.</p></div><div className="footer-links"><div><b>Explore</b><a href="#services">Services</a><a href="#about">About us</a><a href="#products">Products</a></div><div><b>Contact</b><a href="#contact">Get in touch</a><a href="tel:+31201234567">+31 (0)20 123 45 67</a><a href="mailto:hello@fieldcraft.agri">Email us</a></div><div><b>Follow</b><a href="#top">LinkedIn ↗</a><a href="#top">Instagram ↗</a></div></div><div className="footer-bottom"><span>© 2024 Fieldcraft Agricultural Solutions</span><span>Privacy policy &nbsp; Cookies</span></div></footer>
    </main>
  )
}
